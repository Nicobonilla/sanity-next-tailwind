...
// Query: *[_type == 'page' && slug.current == $slug][0] {  "id": _id,  "title": title,  "slug": slug.current,  position,  content,  components[isActive] {   content,  image,  isBgImage,  isActive,  "typeComponentValue": typeComponent->value,  invertLayoutMobile,  invertLayoutDesk,  items[isActive] {    isActive,    image,    svgIcon,    icon,    alt,    position,    content  } },  "isHome": isHome}
