...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      initialValue: 'Agendar consulta virtual',
      validation: (rule) => rule.max(40),
    }),
    defineField({
      name: 'secondaryLabel',
      title: 'Texto boton WhatsApp',
      description: 'Este texto se usa para el boton secundario de WhatsApp.',
      type: 'string',
      initialValue: 'Hablar por WhatsApp',
      validation: (rule) => rule.max(40),
    }),
  ],
  preview: {
