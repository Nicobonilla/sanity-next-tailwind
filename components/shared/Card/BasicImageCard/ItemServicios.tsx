    ...
    return (
        <div className="w-auto bg-white text-center">
            <div className="relative w-full h-[50vh] max-h-80 overflow-hidden rounded group z-0">
                ...
                />
                <div className="absolute top-0 left-0 size-full bg-menuColor2/50 transition duration-300 group-hover:bg-slate-200/90"></div>
                <div className="absolute top-0 left-0 size-full flex items-center justify-center z-20">
