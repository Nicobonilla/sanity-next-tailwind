...
export default function Form() {
  ...
  const color = 'gray';
  return (
    <div className="relative mx-auto flex flex-col items-center gap-10 overflow-hidden bg-gray-100 p-8 text-slate-700 md:flex-row md:justify-center dark:text-slate-700">
