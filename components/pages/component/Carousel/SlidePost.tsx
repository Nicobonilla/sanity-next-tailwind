...
export default function SlidePost({
  ...
  const { imageBackground } = post.components.find((component) => component.typeComponentValue === "Heading") || {}
        ...
        <article className="flex h-full min-h-[420px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-shadow hover:shadow-lg">
          <div className="grid">
            <div className="relative h-48 overflow-hidden">
              <ImageBg
                imgBg={imageBackground ?? null}
                index={1}
                className={
                  "h-48 overflow-hidden object-cover transition-transform duration-300 ease-out group-hover:scale-110"
                }
