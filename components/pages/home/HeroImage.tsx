...
export function HeroImage() {
  ...
  return (
    <div className="relative h-[70vh] w-full">
      ...
      <div className="layer layer1 dark:bg-body-dark z-10 bg-gray-100"></div>
      <div className="layer layer2 dark:bg-body-dark/60 bg-gray-100/70"></div>
      <div className="layer layer3 dark:bg-body-dark/40 bg-gray-100/40"></div>
